...
public:
  enum {
    ...
    T_MOD = 12, T_RETURN = 13, T_INT = 14, T_VOID = 15, T_IF = 16, T_ELSE = 17, 
    T_WHILE = 18, T_BREAK = 19, T_CONTINUE = 20, T_ID = 21, T_DIGIT = 22, 
    WS = 23
  };
  ...
  enum {
    ...
    RuleAddExp = 12, RuleMulExp = 13, RuleAddOp = 14, RuleMulOp = 15, RuleUnaryExp = 16, 
